 module constants
    ...
    real,parameter::dilation = 1.75
 	...
 	integer,parameter::NumNeighborEBC = 8*nGBC ! the maximum num of neighbors for an essential boundary node
 	integer,parameter::NumNeighborNBC = 8*nGBC ! the maximum num of neighbors for a natural boundary node

 	!material properties
 	real,parameter::Imoment = Height**3/12.0
 	real,parameter::Pforce = 1000.0
    real,parameter::Emod = 0.30E+08
    real,parameter::nu =  0.3
 	real,parameter::HookMat(3,3) = reshape(Emod/(1.0-nu**2)*(/ 1., nu, 0., nu, 1., 0., 0., 0., (1.0-nu)/2. /), (/3,3/))
